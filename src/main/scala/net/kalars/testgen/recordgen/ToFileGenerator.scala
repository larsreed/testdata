...
class ToFileGenerator[T](fileName:String, 
...
object ToFileGenerator {
  def apply[T](fileName:String,
               generator: Generator[T],
               append:Boolean=false,
               charSet:String="ISO-8859-1"): ToFileGenerator[T]=
    new ToFileGenerator(fileName, generator, append, charSet)
}
