...
import no.netcompany.testdatagen.{GeneratorDelegate, Generator}
import no.netcompany.testdatagen.aggreg.{FieldConcatenator, TextWrapper, WeightedGenerator}
import no.netcompany.testdatagen.generators.{FromFile, Strings}
