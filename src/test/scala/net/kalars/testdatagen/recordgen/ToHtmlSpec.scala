...
import net.kalars.testdatagen.generators.misc.{MailAddresses, Urls}
import net.kalars.testdatagen.generators.norway.{Fnr, Kjennemerker, NorskeNavn}
import net.kalars.testdatagen.generators.{Booleans, Dates, Doubles, FromList, Ints, Strings}
