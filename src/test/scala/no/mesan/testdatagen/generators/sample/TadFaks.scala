...
import no.mesan.testdatagen.aggreg.{TwoFromFunction, UniqueWithFallback, TwoWithPredicate, SequenceOf, SomeNulls}
import no.mesan.testdatagen.generators.misc.Names
import no.mesan.testdatagen.generators.norway.{NorskeNavn, RareNavn}
import no.mesan.testdatagen.generators.{Booleans, FromList, Ints, Strings, Dates}
