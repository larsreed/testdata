...
import no.netcompany.testdatagen.aggreg.TwoFromFunction
import no.netcompany.testdatagen.generators.{Dates, FromList, Ints}
import no.netcompany.testdatagen.recordgen.ToCsv
