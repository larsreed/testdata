...
import no.netcompany.testdatagen.generators.misc.{MailAddresses, Names, Urls}
import no.netcompany.testdatagen.generators.norway.{Fnr, Kjennemerker}
import no.netcompany.testdatagen.generators.{Booleans, Chars, Dates, Doubles, FromList, Ints, Strings}
